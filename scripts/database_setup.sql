...
-- Events (30 examples)
-------------------------------------------------------
INSERT INTO Event (Name, Category, Description, Latitude, Longitude, StartTime, EndTime, ApplicationDeadline, UserId) VALUES 
('Sprzątanie bulwarów','Środowisko','Wolontariusze sprzątają bulwary wiślane. Udział otwarty. ',50.0614,19.9383,'2025-10-10 10:00','2025-10-10 14:00','2025-10-08 23:59',16), 
('Warsztaty teatralne','Kultura','Warsztaty dla dzieci w teatrze.','50.0620',19.9400,'2025-11-05 15:00','2025-11-05 18:00','2025-11-02 23:59',23), 
('Zbiórka żywności','Społeczność','Zbieramy produkty dla potrzebujących rodzin.','50.0630',19.9360,'2025-10-20 09:00','2025-10-20 17:00','2025-10-18 23:59',16), 
('Bieg dla zdrowia','Sport','Charytatywny bieg w parku Jordana.','50.0650',19.9350,'2025-09-15 08:00','2025-09-15 12:00','2025-09-10 23:59',25), 
('Lekcje angielskiego','Edukacja','Zajęcia dla seniorów w bibliotece.','50.0660',19.9390,'2025-12-01 17:00','2025-12-01 19:00','2025-11-28 23:59',22), 
('Koncert młodych talentów','Kultura','Występy uczniów lokalnych szkół.','50.0615',19.9420,'2025-12-10 18:00','2025-12-10 21:00','2025-12-05 23:59',21), 
('Warsztaty plastyczne','Kultura','Warsztaty malarskie dla dzieci i młodzieży.','50.0600',19.9340,'2025-09-22 14:00','2025-09-22 16:00','2025-09-19 23:59',17), 
('Pomoc w schronisku','Zwierzęta','Opieka nad psami i kotami w schronisku.','50.0635',19.9370,'2025-10-12 10:00','2025-10-12 14:00','2025-10-10 23:59',24), 
('Kurs komputerowy','Edukacja','Bezpłatne szkolenie z obsługi komputera.','50.0625',19.9410,'2025-11-20 16:00','2025-11-20 19:00','2025-11-17 23:59',18), 
('Akcja krwiodawstwa','Zdrowie','Zachęcamy do oddawania krwi.','50.0640',19.9365,'2025-10-25 09:00','2025-10-25 14:00','2025-10-22 23:59',20), 
('Turniej piłki nożnej','Sport','Turniej dla młodzieży szkolnej.','50.0612',19.9395,'2025-09-30 09:00','2025-09-30 15:00','2025-09-27 23:59',25), 
('Warsztaty kulinarne','Społeczność','Nauka zdrowego gotowania.','50.0638',19.9388,'2025-10-15 12:00','2025-10-15 15:00','2025-10-12 23:59',20), 
('Spektakl dla dzieci','Kultura','Przedstawienie teatralne dla najmłodszych.','50.0628',19.9405,'2025-09-18 10:00','2025-09-18 12:00','2025-09-15 23:59',23), 
('Sadzenie drzew','Środowisko','Wspólne sadzenie drzew w parku.','50.0645',19.9345,'2025-11-02 09:00','2025-11-02 13:00','2025-10-30 23:59',16), 
('Zajęcia sportowe','Sport','Ćwiczenia dla seniorów na świeżym powietrzu.','50.0618',19.9372,'2025-10-05 09:00','2025-10-05 11:00','2025-10-02 23:59',25), 
('Kurs pierwszej pomocy','Zdrowie','Szkolenie z udzielania pierwszej pomocy.','50.0652',19.9381,'2025-12-02 10:00','2025-12-02 14:00','2025-11-28 23:59',20), 
('Gra terenowa','Społeczność','Integracyjna gra miejska w centrum Krakowa.','50.0622',19.9399,'2025-09-25 12:00','2025-09-25 16:00','2025-09-22 23:59',19), 
('Warsztaty literackie','Kultura','Spotkanie z młodymi pisarzami.','50.0617',19.9411,'2025-11-18 17:00','2025-11-18 20:00','2025-11-15 23:59',22), 
('Zbiórka ubrań','Społeczność','Zbieramy ubrania dla potrzebujących.','50.0609',19.9362,'2025-10-28 09:00','2025-10-28 18:00','2025-10-25 23:59',16), 
('Maraton taneczny','Kultura','Całodniowe warsztaty taneczne.','50.0631',19.9359,'2025-12-12 10:00','2025-12-12 18:00','2025-12-09 23:59',21), 
('Kiermasz książek','Społeczność','Sprzedaż i wymiana książek w bibliotece.','50.0629',19.9377,'2025-09-20 09:00','2025-09-20 17:00','2025-09-17 23:59',22), 
('Festyn rodzinny','Społeczność','Impreza plenerowa dla rodzin.','50.0611',19.9392,'2025-09-29 12:00','2025-09-29 18:00','2025-09-25 23:59',19), 
('Spotkanie chóru','Kultura','Otwarte próby chóru.','50.0619',19.9367,'2025-10-07 17:00','2025-10-07 19:00','2025-10-04 23:59',21), 
('Wycieczka edukacyjna','Edukacja','Zwiedzanie zabytków Krakowa z przewodnikiem.','50.0634',19.9391,'2025-11-22 10:00','2025-11-22 15:00','2025-11-19 23:59',18), 
('Sprzątanie parku','Środowisko','Akcja sprzątania Parku Jordana.','50.0641',19.9386,'2025-09-12 09:00','2025-09-12 13:00','2025-09-09 23:59',16), 
('Pokaz filmowy','Kultura','Seans filmowy z dyskusją.','50.0626',19.9408,'2025-10-18 18:00','2025-10-18 21:00','2025-10-15 23:59',21), 
('Zajęcia matematyczne','Edukacja','Korepetycje dla uczniów szkoły podstawowej.','50.0607',19.9351,'2025-12-04 15:00','2025-12-04 17:00','2025-12-01 23:59',17), 
('Spotkanie seniorów','Społeczność','Klub dyskusyjny dla seniorów.','50.0613',19.9375,'2025-11-12 11:00','2025-11-12 13:00','2025-11-09 23:59',19), 
('Konferencja naukowa','Edukacja','Wykłady i prezentacje dla studentów.','50.0624',19.9384,'2025-12-08 09:00','2025-12-08 17:00','2025-12-05 23:59',18), 
('Zbiórka karmy','Zwierzęta','Zbieramy karmę dla psów i kotów.','50.0633',19.9371,'2025-09-19 10:00','2025-09-19 16:00','2025-09-16 23:59',24);
