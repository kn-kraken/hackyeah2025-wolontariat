...
>
    ...
    >
        ...
        <p class="text-gray-500 mb-6">Dzięki za twoją informację zwrotną!</p>
        ...
        <form on:submit|preventDefault={handleSubmit}>
            <div class="mb-5">
                ...
                {#if rating > 0}
                    <p class="text-sm text-gray-500 mt-2">Dałeś ocenę: <span class="font-medium text-yellow-600">{rating}</span> na 5</p>
                {/if}
            </div>
            
            <div class="mb-6">
                <label for="review" class="block text-sm font-medium text-gray-700 mb-1">Krótka recenzja (Max {MAX_CHARACTERS} znaków)</label>
                <textarea 
                    id="review"
                ...
                <p class="text-xs text-gray-500 text-right mt-1">
                    {reviewText.length} / {MAX_CHARACTERS} znaków
                </p>
            </div>
